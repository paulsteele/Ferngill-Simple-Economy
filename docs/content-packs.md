...
| `AddToEconomy`         | Includes an item in economy calculations even if the item's category was not added by the user.                                                                  | `id` (string, required): The item ID to include                                                                                                                                                  | `{"action": "AddToEconomy", "id": "74"}`                                                                     |
