...
* You sell an item at a shop
* You sell an item through the shipping bin
* The day ends and daily change is applied (see below)

Supply will not change when:

* An item is bought at a shop (unless it is being bought back)
...
In the image below, green beans have a negative daily change. This means the supply will lower each day during the season, and in turn prices will be higher the longer you wait to sell in the season.
...
**Note:** Knowing how the mod works on a technical level is not necessary to enjoy it. I have tweaked the default settings over six separate multi-year playthroughs, so they are fairly reasonable by default.
...
## Contributing
Interested in contributing? Please read the https://github.com/paulsteele/Ferngill-Simple-Economy/blob/main/CONTRIBUTING.md 
...
The source is available at https://github.com/paulsteele/Ferngill-Supply-And-Demand under a [MIT License](https://github.com/paulsteele/Ferngill-Simple-Economy?tab=MIT-1-ov-file). I'd love if you'd submit improvements through a PR on this mod, but you're free to fork and re-upload however you see fit.

## Credits

### Libraries

* [Math.NET Numerics](https://numerics.mathdotnet.com/) - Backing algorithms used to seed data
